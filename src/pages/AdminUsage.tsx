...
export default function UsagePage() {
  ...
  useEffect(() => {
    getUsageMetrics().then((m) => { setMetrics(m); setLoading(false); });
  }, []);
  ...
  const cards = [
    { label: "Tickets Today", value: metrics.ticketsToday, icon: TicketCheck, color: "text-blue-500" },
    ...
    { label: "Recordings Created", value: metrics.recordingsCreated, icon: Video, color: "text-pink-500" },
